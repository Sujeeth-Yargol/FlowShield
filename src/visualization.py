...
def render_grid_heatmap(sim_res: dict, time_idx: int, layer_mode: str):
    ...
    colorscale = [
        ...
        [0.6, "#f39c12"],   # Warning - Yellow/Orange
        [0.9, "#e74c3c"],   # Critical - Red
        [1.0, "#900c3f"]
    ...
    fig.update_layout(
        ...
        xaxis=dict(showgrid=True, gridcolor="#2D3748", zeroline=False, title="Grid Easting (Columns)"),
        yaxis=dict(showgrid=True, gridcolor="#2D3748", zeroline=False, autorange="reversed", title="Grid Northing (Rows)"),
